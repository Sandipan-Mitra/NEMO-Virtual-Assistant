...
def MainExecution():
    ...
    while True:       
        ...
        if len(command)<=4:
            ...
            subject = understand()
            #Blank feild
            subject = isBlank(subject, topic_msg="Please tell me your destination location.")
